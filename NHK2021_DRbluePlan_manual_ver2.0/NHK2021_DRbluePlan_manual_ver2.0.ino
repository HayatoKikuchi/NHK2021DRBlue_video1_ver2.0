...
void loop()
{
  ...
  {  
    ...
    int num = Con.setAvailable(dipsw_state & DIP1_CON);
  ...
  { 
    ...
    lcd.write_str("refAngle:",LINE_4,1);
    ...
    lcd.write_double(ManualCon.refAngle,LINE_4,11);
    
   
    //lcd.write_int(Con.getButtonState(),LINE_1,2);
    //lcd.write_int(Con.readJoy(RY),LINE_2,2);
